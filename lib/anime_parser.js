...
export const scrapeRecentRelease = async ({
  ...
  try {
    const mainPage = await axios.get(`https://gogoanime3.co/?page=${page}&type=${type}
        `);
...
export const scrapeAnimeList = async ({ list = [], page = 1 }) => {
  try {
    const AnimeList = await axios.get(
      `https://gogoanime3.co/anime-list.html?page=${page}`,
    );
...
export const scrapeAnimeAZ = async ({ list = [], aph, page = 1 }) => {
  try {
    const AnimeAZ = await axios.get(
      `https://gogoanime3.co/anime-list-${aph}?page=${page}`,
    );
...
export const scrapeOngoingSeries = async ({ list = [], page = 1 }) => {
  try {
    const OngoingSeries = await axios.get(
      `https://gogoanime3.co/?page=${page}`,
    );
...
export const scrapeOngoingAnime = async ({ list = [], page = 1 }) => {
  try {
    const OngoingAnime = await axios.get(
      `https://gogoanime3.co/ongoing-anime.html?page=${page}`,
    );
...
export const scrapeCompletedAnime = async ({ list = [], page = 1 }) => {
  try {
    const CompletedAnime = await axios.get(
      `https://gogoanime3.co/completed-anime.html?page=${page}`,
    );
  ...
  try {
    ...
    if (Genres.indexOf(genre) > -1) {
      const genrePage = await axios.get(
        `https://gogoanime3.co/genre/${genre}?page=${page}`,
      );
...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const animePageTest = await axios.get(
      `https://gogoanime3.co/category/${id}`,
    );
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const WatchAnime = await axios.get(`https://gogoanime3.co/${id}`);
...
export const scrapePopularPage = async ({ page }) => {
  try {
    const PopularPage = await axios.get(
      `https://gogoanime3.co/popular.html?page=${page}`,
    );
...
export const scrapeMoviePage = async ({ page }) => {
  try {
    const MoviePage = await axios.get(
      `https://gogoanime3.co/anime-movies.html?aph=&page=${page}`,
    );
...
export const scrapeSubCategoryPage = async ({ subCategory, page }) => {
  try {
    const SubCategoryPage = await axios.get(
      `https://gogoanime3.co/sub-category/${subCategory}?page=${page}`,
    );
...
export const scrapeRecentPage = async ({ page, type }) => {
  try {
    const RecentPage = await axios.get(
      `https://gogoanime3.co/?page=${page}&type=${type}`,
    );
...
export const scrapeNewSeasonPage = async ({ page }) => {
  try {
    const NewSeasonPage = await axios.get(
      `https://gogoanime3.co/new-season.html?page=${page}`,
    );
